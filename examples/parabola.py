...
if __name__ == "__main__":
    ...
    plotResults(tr["X"][tr.offset:], "SDMM", boundary=boundary)
    ...
    if boundary == "line":
        ...
        traj = np.dstack([tr["X",0][tr.offset:], tr["X",1][tr.offset:]])[:,0,:]
